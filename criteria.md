...
Judging Period: Tuesday, December 1, 2026 (9:00 am Pacific Time) – Tuesday, December 15, 2026 (12:00 pm Pacific Time) (“Judging Period”).

Winners Announced: On or around Monday, January 11, 2027 (12:00 pm Pacific Time).

 
2. Sponsor and Administrator
Sponsor: Nebius B.V., Schiphol Boulevard 165, 1118 BG Schiphol, the Netherlands
...
4. How To Enter 
Entrants may enter by visiting nebiusglobalaihackathon.devpost.com (“Hackathon Website”) and following the below steps:
...
Entrants can join the Nebius Builder Program and get credits for Nebius Token Factory, Tavily, and Nebius Academy — plus training, office hours, and access to the builder community.
...
What to Create: Entrants must create a working software application that runs on either Nebius Token Factory or Nebius AI Cloud and uses at least one NVIDIA open source model, and that fits into one of the four hackathon tracks below (each a “Project”). 

Runs on Nebius Token Factory or Nebius AI Cloud" means the project makes a runtime call to the Token Factory inference API, or is deployed/run using Nebius AI Cloud compute (Serverless Jobs, Serverless Endpoints, or DevPods).
...
Provide a URL to a working demo, hosted application, or test build of your Project (not required for Physical AI submissions, which are evaluated per the hardware-access provision below).

Include a text description that should explain the features and functionality of your Project.

Provide a URL to your public code repository for judging and testing on either GitHub, GitLab or Bitbucket. 

The repository must contain all necessary source code, assets, and instructions required for the project to be functional. 

The repository must be public and open source by including an open source license file (such as Apache 2.0, MIT, or MPL 2.0). This license should be detectable and visible at the top of the repository page (in the About section). 

Include a README with setup instructions and clear guidance for running your project.

Make sure to highlight how you’ve used NVIDIA Nemotron or other NVIDIA open source models and where Token Factory accelerated your workflow and any other Nebius Tools or Services used.
...
must be uploaded to and made publicly visible on YouTube and a link to the video must be provided on the submission form on the Hackathon Website; and must not include third party trademarks, or copyrighted music or other material unless the Entrant has permission to use such material.

for Physical AI Track submissions, should include at least one minute of footage showing the physical hardware/robot actually operating, or — if the Project has no physical hardware component — the key application modules in action.

Identify which track you are submitting your Project into.

Provide feedback on Nebius Token Factory, AI Cloud and any NVIDIA tools, models, or technologies used.

If your Project existed before the Submission Period, include a written explanation of what was significantly updated during the Submission Period.
